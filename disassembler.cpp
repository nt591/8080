// disassembler takes the entire file buffer and an offset to a place in the buffer
...
int Disassemble(unsigned char* codebuffer, int pc) {
  ...
  // return size of opcode bytes
  int opcodeSize = 1;
  printf("%04x ", pc);
  switch (*code) {
    default: printf("Unknown opcode %02x", code[0]);
    ...
    case 0x79: printf("MOV     A,C"); break; // move C to A
    ...
    case 0x83: printf("ADD     E"); break; // add E to A
    ...
    case 0x8b: printf("ADC     E"); break; // add E to A and also add carry
    case 0x8c: printf("ADC     H"); break;
    case 0x8d: printf("ADC     L"); break;
    case 0x8e: printf("ADC     M"); break;
    case 0x8f: printf("ADC     A"); break;
    case 0x90: printf("SUB     B"); break;
    case 0x91: printf("SUB     C"); break; // subtract C from C
    ...
    case 0x9a: printf("SBB     D"); break; // subtract D and carry from A
    ...
    case 0xb1: printf("ORA     C"); break; // A = A | B
    ...
    case 0xb9: printf("CMP     C"); break; // compare -> A - C
    ...
    case 0xc1: printf("POP"); break; // pops SP into C, SP+1 into B, SP += 2
    ...
    case 0xce: printf("ACI     $%02x", code[1]); opcodeSize = 2; break; // add immediate value to A with carry
    case 0xcf: printf("RST"); break;
    case 0xd0: printf("RNC"); break;
    case 0xd1: printf("POP     D"); break;		// D <- (sp); D <- (sp+1); sp <- sp+2
    case 0xd2: printf("JNC     $%02x%02x", code[2], code[1]); opcodeSize = 3; break;
    case 0xd3: printf("OUT     #$%02x", code[1]); opcodeSize = 2;  break; // output data
    case 0xd4: printf("CNC     $%02x%02x", code[2], code[1]); opcodeSize = 3; break;
    case 0xd5: printf("PUSH    D"); break;
    case 0xd6: printf("SUI     #$%02x", code[1]); opcodeSize = 2; break; // A <- A - data
    ...
    case 0xde: printf("SBI     #$%02x", code[1]); opcodeSize = 2; break; // A <- A - data - CY
    case 0xdf: printf("RST     3"); break;
    case 0xe0: printf("RPO"); break;
    case 0xe1: printf("POP     H"); break; //H <- (sp+1); sp <- sp+2
    case 0xe2: printf("JPO     $%02x%02x", code[2], code[1]); opcodeSize = 3; break;
    case 0xe3: printf("XTHL"); break;		// Exchange top of stack; L <-> (SP); H <-> (SP+1)
    case 0xe4: printf("CPO     $%02x%02x", code[2], code[1]); opcodeSize = 3; break;
    case 0xe5: printf("PUSH    H"); break;
    case 0xe6: printf("ANI     #$%02x", code[1]); opcodeSize = 2; break;	// A <- A & data
    ...
    case 0xee: printf("XRI     #$%02x", code[1]); opcodeSize = 2; break; //	A <- A ^ data
    case 0xef: printf("RST     5"); break;
    case 0xf0: printf("RP"); break;
    case 0xf1: printf("POP     PSW"); break; // flags <- (sp); A <- (sp+1); sp <- sp+2
    ...
    case 0xf5: printf("PUSH    PSW"); break;	// (sp-2)<-flags; (sp-1)<-A; sp <- sp - 2
    case 0xf6: printf("ORI     #$%02x", code[1]); opcodeSize = 2; break; //	A <- A | data
    ...
    case 0xfe: printf("CPI     #$%02x", code[1]); opcodeSize = 2; break; // A - data
